		...
		<div class="row sidebar" style="min-height:700px;">
			<div class="col-md-2 sidebarShop">
				<div class="row">
					<div class="col-12 pt-5">
						...
						?>
							<a href="<?= Configuration::BASE_URL?>product/<?php echo $cat->category_id?>"><li class="list-group-item"><?= htmlspecialchars($cat->name);?></li></a>
			...
			<div class="col-md-10 products pt-5">
				<div class="selectByButton clearfix border-bottom mb-5">
					...
					<form method='post' action='<?= Configuration::BASE_URL?>products'>
				...
				<div class="row text-center">
					...
					<div class="col-md-2 col-sm-3 col-6 mb-3">
						<div class="card ml-auto mr-auto">
							<div class="item">
						  		<a href="<?=Configuration::BASE_URL?>details/<?=$item->product_id?>"><img class="card-img-top" src="assets/img/<?=htmlspecialchars($item->image);?>" alt="Card image cap"></a>
						  	</div>
						  	<div class="card-body p-0">
						    <a href="product.php" class="card_title"><h6 class="card-title text-left ml-2"><?=htmlspecialchars($item->name);?></h6></a>
						    <p class="card-text text-left ml-2 mb-0"><b><?=htmlspecialchars($item->price);?> Din.</b></p>
