		...
		<div class="row sidebar" style="min-height:700px;">
			<div class="col-md-2 sidebarShop">
				<div class="row">
					<div class="col-12 pt-5">
						...
						?>
							<a href="<?= Configuration::BASE_URL?>admin/<?php echo $cat->category_id?>"><li class="list-group-item"><?=$cat->name?></li></a>
			...
			<div class="col-md-10 products pt-5">
				<div class="selectByButton clearfix border-bottom mb-5">
					...
					<form method='post' action="<?= Configuration::BASE_URL?>admin/<?php echo $cat->category_id?>">
				...
				<div class="row text-center">
					...
					<div class="col-md-2 col-sm-3 col-6 mb-3">
						<div class="card ml-auto mr-auto">
						    ...
						    <a href="<?= Configuration::BASE_URL?>update/<?php echo $cat->category_id?>" class="btn btn-outline-dark  mb-2">Update</a>
								<a href="<?= Configuration::BASE_URL?>delete/<?php echo $cat->category_id?>" class="btn btn-outline-dark  mb-2">Delete</a>
						  </div>
						</div>
					</div>
					<?php
